...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#231123]">
      ...
      <div className="container-custom relative z-10 py-8">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <div className="mb-8 inline-flex animate-fade-in items-center gap-2 rounded-full border-2 border-primary-500 bg-primary-500/20 backdrop-blur-sm px-6 py-3 shadow-lg shadow-primary-500/25">
          ...
          <h1 className="mb-6 animate-slide-up">
            ...
            <span className="block bg-gradient-to-r from-primary-500 via-primary-600 to-purple-600 bg-clip-text text-6xl font-black uppercase tracking-tighter text-transparent md:text-7xl lg:text-8xl xl:text-9xl">
              HYROX CDMX
            </span>
          </h1>
          ...
          <p className="mx-auto mb-10 max-w-2xl text-lg font-medium leading-relaxed text-gray-300 md:text-xl lg:text-2xl">
            ...
            <span className="text-primary-400">Diseñado para atletas</span> que buscan cambiar el mundo.
          </p>
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <a 
              href="#registro-form" 
              className="btn-primary group text-lg animate-pulse-glow"
          ...
          <div className="mt-20 grid grid-cols-3 gap-6 lg:gap-12">
            <div className="group transform transition-all duration-300 hover:-translate-y-1">
              <div className="mb-3 inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-primary-500 to-primary-600 shadow-lg shadow-primary-500/50 transition-all group-hover:shadow-xl">
            ...
            <div className="group transform transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-3xl font-black text-white lg:text-4xl">100%</p>
          ...
          <div className="mt-16 animate-bounce">
            <a href="#registro-form" className="inline-flex flex-col items-center gap-2 text-gray-400 transition-colors hover:text-primary-500">
