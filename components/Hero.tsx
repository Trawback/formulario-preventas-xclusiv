        ...
        <div className="mx-auto max-w-5xl text-center">
          ...
          <div className="mt-20 grid grid-cols-3 gap-6 lg:gap-12">
            <div className="group transform transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-3xl font-black text-white lg:text-4xl">40</p>
              <p className="mt-1 text-sm font-semibold text-gray-400">Piezas disponibles</p>
            </div>
            ...
            <div className="group transform transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-3xl font-black text-white lg:text-4xl">3 días</p>
